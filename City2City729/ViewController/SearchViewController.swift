...
class SearchViewController: UIViewController {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        //DONE: Divide Cities Alphabetically
        //DONE: Add Section Index Titles
        //DONE: Recent Functionality (Core Data)
        //DONE: Search Functionality
        //DONE: Add Commas to population
        
        //TODO: Map Directions Functionality (Extra Tab)
        //TODO: Get Weather (OpenWeather API - Consume Live Weather Report)
...
//
//        for city in cities {
//            if city.name.lowercased().contains(search.lowercased()) || city.state.lowercased().contains(search.lowercased()) {
